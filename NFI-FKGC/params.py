...
def get_params():
    ...
    args.add_argument("-seed", "--seed", default=100000, type=int)
    ...
    args.add_argument("-lr", "--learning_rate", default=0.0005, type=float)
    args.add_argument("-es_p", "--early_stopping_patience", default=100, type=int)
    ...
    args.add_argument("-prefix", "--prefix", default="exp", type=str)
    ...
    args.add_argument("-eval_ckpt", "--eval_ckpt", default=False, type=str)
    ...
    args.add_argument("-lstm_dim", "--lstm_hiddendim", default=800, type=int)
